...
Файл `dist/AOI-Web-models-1.0.0.zip` прикрепите к Release с тегом **`v1.0.0-models`** — тогда CI-сборка portable подтянет веса автоматически. Артефакт: **`portable-win64-with-models`**.
